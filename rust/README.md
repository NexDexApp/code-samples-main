...
This is a simple example demonstrating how to use the nexdex API in Rust to:
...
For more examples, visit [snow-avocado/nexdex-rs/examples](https://github.com/snow-avocado/nexdex-rs/tree/main/examples).

## Prerequisites

- Rust and Cargo installed
- A nexdex testnet private key

## Setup

1. Clone the repository
2. Add your nexdex testnet private key in `src/main.rs`:

```rust
const nexdex_PRIVATE_KEY: &str = "<private key hex string>";
```
