...
Collection of nexdex code samples, snippets and benchmarks
...
(1) Reference: `java/nexdex/StarknetCurve.groovy`
...
(also referred to as nexdex private key).
...
To get complete understanding of this, please refer to [Onboarding & Wallets](https://docs.nexdex.trade/getting-started/onboarding-and-wallets) section in nexdex documentation.
