...
export async function onboardUser(config: SystemConfig, account: Account) {
  ...
  const headers = {
    ...
    "nexdex-ETHEREUM-ACCOUNT": account.ethereumAccount,
    "nexdex-STARKNET-ACCOUNT": account.address,
    "nexdex-STARKNET-SIGNATURE": signature,
    "nexdex-TIMESTAMP": timestamp,
  };
...
export async function authenticate(config: SystemConfig, account: Account) {
  ...
  const headers = {
    ...
    "nexdex-STARKNET-SIGNATURE": signature,
    "nexdex-TIMESTAMP": timestamp,
    "nexdex-SIGNATURE-EXPIRATION": expiration,
  };
