...
import nexdex.StarknetCurve

class nexdexOrderExample {
    static String apiUrl = "https://api.testnet.nexdex.trade/v1"
    static String chainId = '0x505249564154455f534e5f504f54435f5345504f4c4941' // `PRIVATE_SN_POTC_SEPOLIA`

    // Enter values here
    static String accountAddressStr = '' // nexdex_ACCOUNT_ADDRESS
    static String privateKeyStr = '' // nexdex_PRIVATE_KEY
    ...
    static String getJWT() {
        ...
        def requestHeaders = [
            'nexdex-STARKNET-ACCOUNT': accountAddressStr,
            'nexdex-STARKNET-SIGNATURE': signatureStr,
            'nexdex-STARKNET-MESSAGE-HASH': messageHashStr,
            'nexdex-TIMESTAMP': timestamp.toString(),
            'nexdex-SIGNATURE-EXPIRATION': expiry.toString(),
        ]
    ...
    static getSignature(String message) {
        ...
        // Sign message hash using nexdex.StarknetCurve
        ...
        return """
           {
                ...
                "domain": {"name": "nexdex", "chainId": "%s", "version": "1"},
                "primaryType": "Request",
                "types": {
                    "StarkNetDomain": [
                        {"name": "name", "type": "felt"},
        ...
        return """
            {
                ...
                "domain": {"name": "nexdex", "chainId": "$chainId", "version": "1"},
                "primaryType": "Order",
                "types": {
                    "StarkNetDomain": [
                        {"name": "name", "type": "felt"},
