...
class nexdexAuthExample {
    static void main(String... args) {
        // Enter values here
        String accountAddressStr = '' // nexdex_ACCOUNT_ADDRESS
        String privateKeyStr = '' // nexdex_PRIVATE_KEY
        ...
        def apiUrl = 'https://api.testnet.nexdex.trade/v1/auth/'
        def requestHeaders = [
            'nexdex-STARKNET-ACCOUNT': accountAddressStr,
            'nexdex-STARKNET-SIGNATURE': signatureStr,
            'nexdex-STARKNET-MESSAGE-HASH': messageHash.hexString().toString(),
